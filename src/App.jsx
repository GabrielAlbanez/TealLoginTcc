  ...
  return (
    <div>
      <div className="flex itens-center justify-between ">
        <div>
          <p className="flex items-center gap-3 p-7  dark:text-white">
            <ImArrowLeft2 className="text-2xl hover:cursor-pointer dark:text-white" />{" "}
            voltar
          </p>
        </div>
        <div>
          <p className="p-7">
            {tema === "light" ? (
              ...
              <WiDaySunny
                className="text-3xl hover:cursor-pointer text-white"
                onClick={() => {
                  setTema("light");
                }}
              />
        ...
        <div className="flex w-1/2 h-1/2 bg-white lex flex-col justify-center  rounded-md px-8 shadow-lg shadow-zinc-500/40  ">
          <Form>
            <Form.Group className="mb-10" controlId="formBasicEmail">
              <Form.Label className="text-xl dark:text-zinc-950">
                Email address
              </Form.Label>
              <Form.Control
                type="email"
            ...
            <div className="flex items-center justify-between pr-10">
              <div>
                <Button variant="outline-primary" className="text-center flex">
                  Logar
                </Button>
              </div>
              <div>
                ...
                <a
                  href=""
                  className=" no-underline  text-purple-500 hover:underline  hover:text-purple-500 "
                >
                  Forget Password
                </a>{" "}
              </div>
